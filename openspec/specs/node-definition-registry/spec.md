# node-definition-registry Specification

## Purpose
Define a single registry-driven contract for action node metadata, defaults, summary text, and parameter editor rendering.
## Requirements
